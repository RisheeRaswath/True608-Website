  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white font-sans selection:bg-blue-500 selection:text-white">
      ...
      <div className="pt-32 pb-20 px-6 max-w-4xl mx-auto text-center">
        ...
        {/* HERO TEXT - SIZE IS PERFECT FOR AUTHORITY */}
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          {/* LAUNCH APP - DIRECT ACCESS (Low Friction) */}
          <Link 
            href="/log" 
            className="w-full sm:w-auto h-12 px-8 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-bold flex items-center justify-center gap-2 transition-all hover:scale-105 shadow-lg shadow-blue-900/20"
          >
            Open Field Tool <ArrowRight className="w-4 h-4" />
          </Link>
          
          {/* CONTACT SALES - OPENS MAIL APP */}
          <Link 
            href="mailto:sales@true608.com" 
            className="w-full sm:w-auto h-12 px-8 rounded-full border border-slate-700 hover:border-slate-500 text-slate-300 font-medium flex items-center justify-center gap-2 transition-all hover:bg-white/5"
          >
            Contact Sales
          </Link>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 border-t border-white/5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-blue-500/30 transition-colors group">
            ...
            <h3 className="text-lg font-bold mb-2 text-white">EPA Compliant</h3>
            <p className="text-slate-400 text-sm leading-relaxed">Built strictly to Section 608 standards. Never lose a paper log again.</p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-emerald-500/30 transition-colors group">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">Track gas usage across all job sites instantly from the Command Center.</p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-purple-500/30 transition-colors group">
            ...
            <h3 className="text-lg font-bold mb-2 text-white">Secure Vault</h3>
            <p className="text-slate-400 text-sm leading-relaxed">Your data is encrypted and backed up in the cloud. Accessible anywhere.</p>
          </div>
        </div>
      </div>
